<%-- 
    ...
    Created on : Mar 16, 2022, 5:34:10 PM
    Author     : ASUS
--%>
        ...
        <div class="form-login">
            ...
            <form action="changeAccount" method="POST">
                ...
                <div class="container">
                    ...
                    <input type="text" placeholder="Enter Email" value="${account.email}" name="email" required>

                    <label for="psw"><b>User Name</b></label>
                    <input type="text" placeholder="Enter User Name" value="${account.userName}" name="name" required>
                ...
                <div class="container" style="background-color:#f1f1f1">
                    ...
                    <span class="private"><a href="ChangePassword.jsp">Change Password</a></span>
                </div>
            </form>
        </div>
    </body>
