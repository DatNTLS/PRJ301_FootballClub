 ...
 * @author ASUS
 */
@WebServlet(name = "LoadPlayerControl", urlPatterns = {"/loadPlayer"})
public class LoadPlayerControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("TeamPlayer.jsp").forward(request, response);
    }
