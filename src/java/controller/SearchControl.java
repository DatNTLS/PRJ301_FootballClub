...
public class SearchControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        ArrayList<Player> listPlayer = dao.searchPlayer(input);
        ArrayList<Coach> listCoach = dao.searchCoach(input);
        ArrayList<News> listNews = dao.searchNews(input);
        ArrayList<TypeNews> listTypeNews = dao.getAllTypeNews();
        int count = listPlayer.size() + listCoach.size() + listNews.size();
