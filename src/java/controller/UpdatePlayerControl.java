 ...
 * @author ASUS
 */
@WebServlet(name = "UpdatePlayerControl", urlPatterns = {"/updatePlayer"})
public class UpdatePlayerControl extends HttpServlet {
...
//        processRequest(request, response);
        ...
        DAO dao = new DAO();
        dao.updatePlayer(playerId, playerName, img, dob, birthPlace, nationalityId, height, weight, roleId, imgBackground, number, shortDescription, playerInfor,detail);
